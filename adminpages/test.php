			...
			<div class="center_item">
				...
				<div class="middletext">
					...
					?>
                        ...
                        <label for="product_jq">ID-ul fara JQ:</label>
						<input type="text" id="product_jq" name="product_jq" class="data">
                        <label for="product_jq" id="responseJQ"></label><br>
